...
### Via Google Colab:
Copie o código e cole no Notebook. 
Obs.: o `pli 2.py` precisa acessar o arquivo da instância, então é necessario fazer upload da instância de interesse no Google Colab.
